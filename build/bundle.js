...
var Random = require('./pages/Random');
// endinject

var menuItems = [
  // inject:menuitems
  { payload: 'home', text: 'Main' },
  { payload: 'random', text: 'Random Page' },
  // endinject
];

var titles = {
  // inject:titles
  '/home': 'IAT381 Lab Challange 3',
...
var routes = (
  React.createElement(Route, {name: "app", path: "/", handler: Master}, 
	...
	/* inject:route */
    React.createElement(Route, {name: "random", handler: Random})
    /* endinject */
  )
);
...
},{"./pages/HomePage":250,"./pages/Random":251,"material-ui":7,"react":249,"react-router":50,"react-tap-event-plugin":87}],2:[function(require,module,exports){
/*!
  ...
  render: function () {
    return (
      React.createElement("div", {className: "home-page"}, 
        React.createElement("p", null, "This is a random page about random things.")
      )
    );
  }
});
...
module.exports = React.createClass({displayName: "exports",
  render: function () {
    return (
      React.createElement("div", {className: "random-page"}, 
        React.createElement("li", null, React.createElement("p", null, "What do you want?"))
      )
    );
  }
});
